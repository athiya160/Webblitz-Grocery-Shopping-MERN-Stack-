...
const Footer = () => {
  ...
  const sendMessage = () => {
    window.location = `https://wa.me/9876543210?text=${message}`;
  };
      ...
      <footer>
        <section className="footer">
          <div className="box-container">
            <div className="box">
              <h3>
                Grococery <i>{<RiShoppingBasketFill />}</i>
              </h3>
              <p>
            ...
            <div className="box">
              ...
              <a href="mailto:map12@gmail.com" className="links">
                <i>
          ...
          <div className="credit">
            Created By <span>Map </span> | All Right Reserved
          </div>
        </section>
      </footer>
    </>
